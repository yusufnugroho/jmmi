...
?>
		    	...
		    	<div class="row">
		    		...
		    		<div class="col-footer col-md-4 col-xs-6">
		    			...
		    			<div>
		    				...
		    				<img src="<?php echo $assets_location;?>img/icons/linkedin.png" width="32" alt="LinkedIn">
							<img src="<?php echo $assets_location;?>img/icons/rss.png" width="32" alt="RSS Feed">
						</div>
		    		</div>
		    		<div class="col-footer col-md-4 col-xs-6">
        ...
        <script>window.jQuery || document.write('<script src="<?php echo $assets_location;?>js/jquery-1.9.1.min.js"><\/script>')</script>
